...
func DeleteFavoriteFolderHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteFavoriteFolderReq
		...
		l := favorite.NewDeleteFavoriteFolderLogic(r.Context(), svcCtx)
		resp, code := l.DeleteFavoriteFolder(&req)
		httpx.OkJsonCtx(r.Context(), w, &response.Response{
			Code: code,
