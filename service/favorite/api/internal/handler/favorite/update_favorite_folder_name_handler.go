...
func UpdateFavoriteFolderNameHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateFavoriteFolderNameReq
		...
		l := favorite.NewUpdateFavoriteFolderNameLogic(r.Context(), svcCtx)
		resp, code := l.UpdateFavoriteFolderName(&req)
		httpx.OkJsonCtx(r.Context(), w, &response.Response{
			Code: code,
